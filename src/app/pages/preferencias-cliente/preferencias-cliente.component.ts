...
export class PreferenciasClienteComponent {
  options = [
    { name: 'Excursión', image: 'https://w7.pngwing.com/pngs/663/739/png-transparent-mcleod-ganj-dharamshala-naddi-tibet-dhauladhar-hiking-miscellaneous-cartoon-fictional-character-thumbnail.png', selected: false },
  ...
  save() {
    // Acciones a realizar con las opciones seleccionadas
